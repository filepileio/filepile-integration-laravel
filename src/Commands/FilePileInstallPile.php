...
namespace FilePile\FilePileIntegration\Commands;

use FilePile\FilePileIntegration\Support\Files\FileWriter;
...
class FilePileInstallPile extends Command
{
    ...
    private function getPileFromSlug($pileSlug){
        $apiClient = new \FilePile\FilePileIntegration\API\Client();
